    ...
    def _setup_prompt(
        ...
        if prefix is None:
            if self.domain is None:
                ...
                # Hardcode but is adapted later (only for CBO model)
                prefix = (
                    f"You are an expert {self.domain}. Below you are given Question-Answer pairs. Each question contains three variables: SMILES, SMILES SOLVENT and Temperature."
                    "Your task is to give an answer to the final question as accurately as possible. "
